...
namespace SqliteFTS {
	...
	public class Database {
		...
		public int exec (string sql, Callback? callback = null, out string errmsg = null) {
			...
			SqliteFTS.Memory.free ((void*) sqlite_errmsg);
			return ec;
		}
		...
		public int limit (SqliteFTS.Limit id, int new_val);
		...
		public int get_table (string sql, out string[] resultp, out int nrow, out int ncolumn, out string? errmsg = null) {
			...
			SqliteFTS.Database.free_table (sqlite_resultp);
		...
		public unowned SqliteFTS.Statement next_stmt (SqliteFTS.Statement? current);
		...
		public int status (SqliteFTS.DatabaseStatus op, out int pCurrent, out int pHighwater, int resetFlag = 0);
		...
		public void progress_handler (int n_opcodes, SqliteFTS.ProgressCallback? progress_handler);
	...
	public delegate int AuthorizeCallback (SqliteFTS.Action action, string? p1, string? p2, string db_name, string? responsible);
	[CCode (instance_pos = 0)]
	...
	public delegate void UserFuncCallback (SqliteFTS.Context context, [CCode (array_length_pos = 1.1)] SqliteFTS.Value[] values);
	[CCode (has_target = false)]
	public delegate void UserFuncFinishCallback (SqliteFTS.Context context);
	[CCode (instance_pos = 0)]
	public delegate void UpdateCallback (SqliteFTS.Action action, string dbname, string table, int64 rowid);
	[CCode (instance_pos = 0)]
	public delegate int CompareCallback (int alen, void* a, int blen, void* b);
	[CCode (instance_pos = 0)]
	public delegate int WALHookCallback (SqliteFTS.Database db, string dbname, int pages);
	...
	[CCode (sentinel = "")]
	public static int config (SqliteFTS.Config op, ...);
	...
	public static int status (SqliteFTS.Status op, out int pCurrent, out int pHighwater, int resetFlag = 0);
	...
	public class Statement {
		...
		public int status (SqliteFTS.StatementStatus op, int resetFlg = 0);
		public int step ();
	...
	namespace Memory {
		...
		[Deprecated (since = "3.7.2", replacement = "SqliteFTS.Memory.soft_heap_limit64")]
	...
	public class Context {
		...
		public void result_value (SqliteFTS.Value value);
